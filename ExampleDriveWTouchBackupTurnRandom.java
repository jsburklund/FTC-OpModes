 ...
 */
public class ExampleDriveWTouchBackupTurnRandom extends OpMode {
    ...
    * Constructor
    */
    public ExampleDriveWTouchBackupTurnRandom() {
    ...
    */
    ...
    public void loop() {
        switch(state) {
            ...
            case Backup:
                ...
                if(timer.time() >= BACKUP_TIME) {
                    state = State.Turn;
                    //Calculate a random time to turn between 0.5 seconds and 1.5 seconds
                    turnTime = 0.5 + Math.random();
        ...
        telemetry.addData("turnTime", "Turn Time: " + turnTime + " sec.");
    }
